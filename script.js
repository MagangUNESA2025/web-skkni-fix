...
function tambahData() {
    let namaLSP = document.getElementById("namaLSP").value;
    let dataAsesor = document.getElementById("dataAsesor").value;
    let dataTUK = document.getElementById("dataTUK").value;
    let dataSkema = document.getElementById("dataSkema").value;

    if (namaLSP === "" || dataAsesor === "" || dataTUK === "" || dataSkema === "") {
        alert("Semua field harus diisi!");
        return;
    }
    ...
    // Kosongkan input setelah tambah data
    document.getElementById("namaLSP").value = "";
    document.getElementById("dataAsesor").value = "";
    document.getElementById("dataTUK").value = "";
    document.getElementById("dataSkema").value = "";

    // Sembunyikan form setelah tambah data
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.tambahData = function () {
        let namaLSP = document.getElementById("namaLSP").value.trim();
        let dataAsesor = document.getElementById("dataAsesor").value.trim();
        let dataTUK = document.getElementById("dataTUK").value.trim();
        let dataSkema = document.getElementById("dataSkema").value.trim();
        ...
        newRow.innerHTML = `
            ...
            <td>${dataTUK}</td>
            <td>${dataSkema}</td>
            <td><button class="btn-delete" onclick="hapusData(this)">Hapus</button></td>
        `;
